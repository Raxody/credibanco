...
public class DtoCancelTransactionPurchase {
    ...
    private static final String THE_REFERENCE_NUMBER_MUST_BE_SIX_CHARACTERS_LONG = "El numero de referencia debe tener 6 caracteres exactos";
    ...
    @Size(min = 6, max = 6, message = THE_REFERENCE_NUMBER_MUST_BE_SIX_CHARACTERS_LONG)
